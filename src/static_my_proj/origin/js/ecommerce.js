$(document).ready(function() {
	...
	var contactForm = $(".contact-format")
	...
	function refreshCart() {
		...
		var subTotalCart = $('.cart-subtotal')
		var grandeTotal = $('.cart-total')
			...
			success: function(data) {
				...
				if (data.products.length > 0) {
					...
					$.each(data.products, function(index, value) {
						...
						cartBody.prepend("<tr class=\"cart-product\"><td>" + newCartItemRemove.html() +
							"</td><td class=\"cart-image\"><a class=\"entry-thumbnai\" href='" + value.url + "'>" + "<img src= '" + value.image + "'></a></td><td class=\"cart-product-name-info\">" +
							"<h4 class=\"cart-product-description\"> <a>" + value.name + "</td><td class=\"cart-product-sub-total\"><span class=\"cart-sub-total-price\">"+"</span>" + value.price + "</td></tr>")

						i--
					})

					subTotalCart.text(data.subtotal)
					grandeTotal.text(data.total)
				} else {
