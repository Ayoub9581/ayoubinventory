...
# ayoubarahmat9@gmail.com -->> 1000000 billing profiles
# user ayoubarahmat9@gmail.com -- 1 billing profile

import stripe
STRIPE_SECRET_KEY = getattr(settings, "STRIPE_SECRET_KEY", "sk_test_mRJizGawnt7xOmULP4GcxArN")
...
class ChargeManager(models.Manager):
	def do(self, billing_profile, order_obj, card=None): # Charge.objects.do()
		...
		c = stripe.Charge.create(
			  amount = int(order_obj.total * 100), # 40.19 --> 4019
			  currency = "usd",
